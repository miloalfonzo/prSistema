...
Class Articulo {
    ...
    public function editar($idarcitulo, $idcategoria, $codigo, $nombre, $stock, $descripcion, $imagen){
    ...
    public function listar(){
        ...
        a.codigo, a.stock, a.descripcion, a.imagen, a.condicion FROM 
        articulo a INNER JOIN categoria c ON a.idcategoria=c.idcategoria";
        return ejecutarConsulta($sql);
    }
}
