                  ...
                  <div class="box">
                    ...
                    <div class="panel-body" style="height: 400px;" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                            ...
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <label> Serie: </label>
                                <input type="text" class="form-control" name="serie_comprobante" id="serie_comrpobante"
                                maxLength="7" placeholder="Serie">
                            </div>

                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <label> Número: </label>
                                <input type="text" class="form-control" name="num_comprobante" id="num_comrpobante"
                            ...
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                table-hover">
                                    <thead style="background-color:#A9DEF5">
                                        <th>Opciones</th>
                                        <th>Articulo</th>
                                        <th>Cantidad</th>
                                        <th>Precio compra</th>
